...
import lombok.Data;
import pl.mvasio.snake.domain.*;
import pl.mvasio.snake.suplier.MovementDirection;
import pl.mvasio.snake.domain.snake.Snake;
import pl.mvasio.snake.node.Board;
        ...
        public void run() {
            if (!paused)
                Platform.runLater(()->{
                    ...
                    List<GameNode> snakeView = List.copyOf(snake.getSnakeView());
